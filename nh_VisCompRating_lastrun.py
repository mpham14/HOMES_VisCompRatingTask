...
expName = 'nh_VisCompRating'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/mettapham/Downloads/HOMES_VisCompRatingTask/nh_VisCompRating_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='Welcome to the Visual Complexity Rating Task',
    font='Open Sans',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='You will look at the following objects and rate it 1-5 on how visually complex it is. 1 being not visually complex, 3 being moderately visually complex, and 5 being extremly visually complex.\n\nPress SPACEBAR to begin!',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
# --- Initialize components for Routine "VisComp_Feedback" ---
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='On a scale of 1-5, how visually complex is the object?',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
text_4 = visual.TextStim(win=win, name='text_4',
    text='Thank you for participating in the Visual Complexity Task',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('data/landmark_stims.xlsx'),
...
for thisTrial in trials:
    ...
    # --- Prepare to start Routine "VisComp_Feedback" ---
    continueRoutine = True
    routineForceEnded = False
    # update component parameters for each repeat
    ...
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    VisComp_FeedbackComponents = [imageA, imageB, imageC, text_3, key_resp_2]
    for thisComponent in VisComp_FeedbackComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # --- Ending Routine "VisComp_Feedback" ---
    for thisComponent in VisComp_FeedbackComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # check responses
    ...
    # the Routine "VisComp_Feedback" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    thisExp.nextEntry()
